  ...
  return (
    <div className="container max-w-3xl py-12 md:py-20">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <h3>3. 信息共享</h3>
        <p>除非法律要求，否则我们要不会公开或与第三方共享任何个人身份信息。</p>

        <h3>4. 外部链接</h3>
        <p>
          我们的网站可能包含指向非我们要运营的外部网站的链接。请注意，我们无法控制这些网站的内容和做法，也不能对其各自的隐私政策承担责任或义务。
        </p>

        <h3>5. 用户权利</h3>
        <p>您有权拒绝我们就您的个人信息提出的请求，但我们要可能无法为您提供某些所需的服务。</p>

        <h3>6. 同意</h3>
        <p>
          继续使用我们的网站将被视为接受我们要关于隐私和个人信息的做法。如果您对我们要如何处理用户数据和个人信息有任何疑问，请随时与我们联系。
        </p>
      </div>
    </div>
  );
